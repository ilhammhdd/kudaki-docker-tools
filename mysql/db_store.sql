...
CREATE USER IF NOT EXISTS 'kudaki_store' @'localhost' IDENTIFIED BY 'kudakistorerocks';
GRANT ALL PRIVILEGES ON kudaki_store.* TO 'kudaki_store' @'localhost' WITH GRANT OPTION;
USE kudaki_store;
